...
LEFT = False # pass false for left
RIGHT = True    #pass true for right
...
def draw(canvas):
    ...
    # draw paddles
    canvas.draw_line([HALF_PAD_WIDTH,0 + paddle1_pos],[HALF_PAD_WIDTH, PAD_HEIGHT + paddle1_pos],PAD_WIDTH,"White")
    canvas.draw_line([WIDTH - HALF_PAD_WIDTH, 0 + paddle2_pos],[WIDTH - HALF_PAD_WIDTH, PAD_HEIGHT + paddle2_pos],PAD_WIDTH,"White")
    ...
    # draw scores
    canvas.draw_text(str(score1),(WIDTH/4, HEIGHT/7),40,"Lime")
    canvas.draw_text(str(score2),(WIDTH/1.4, HEIGHT/7),40,"Lime")
def keydown(key):
